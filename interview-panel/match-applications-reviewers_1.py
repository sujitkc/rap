...
# common topic score + Rare topic will get more importance
      topic_weight = sum([1.0/topic_score[t] for t in topic_list])
...
#           match_score = topic_weight / faculty_score[fac]
#           if(faculty_load[f] < MAX_PANELS_PER_FACULTY):
...
#     n = min(PANEL_SIZE,len(review_panels[app]))
#     review_panels[app] = review_panels[app][:n]
#   return review_panels
